<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="运动项目" prop="yundongxiangmu">
          <el-input v-model="ruleForm.yundongxiangmu" 
              placeholder="运动项目" clearable  :readonly="ro.yundongxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="运动项目" prop="yundongxiangmu">
              <el-input v-model="ruleForm.yundongxiangmu" 
                placeholder="运动项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="评语" prop="pingyu">
          <el-input v-model="ruleForm.pingyu" 
              placeholder="评语" clearable  :readonly="ro.pingyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="评语" prop="pingyu">
              <el-input v-model="ruleForm.pingyu" 
                placeholder="评语" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    info(id) {
      this.$http({
        url: `jiaoxuebisaichengji/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiaoxuebisaichengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiaoxuebisaichengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
