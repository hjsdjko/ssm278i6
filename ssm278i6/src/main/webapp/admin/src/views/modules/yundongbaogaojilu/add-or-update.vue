<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报告名称" prop="baogaomingcheng">
          <el-input v-model="ruleForm.baogaomingcheng" 
              placeholder="报告名称" clearable  :readonly="ro.baogaomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报告名称" prop="baogaomingcheng">
              <el-input v-model="ruleForm.baogaomingcheng" 
                placeholder="报告名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="运动地点" prop="yundongdidian">
          <el-input v-model="ruleForm.yundongdidian" 
              placeholder="运动地点" clearable  :readonly="ro.yundongdidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="运动地点" prop="yundongdidian">
              <el-input v-model="ruleForm.yundongdidian" 
                placeholder="运动地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="运动时长" prop="yundongshizhang">
          <el-input v-model="ruleForm.yundongshizhang" 
              placeholder="运动时长" clearable  :readonly="ro.yundongshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="运动时长" prop="yundongshizhang">
              <el-input v-model="ruleForm.yundongshizhang" 
                placeholder="运动时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.yundongtupian" label="运动图片" prop="yundongtupian">
          <file-upload
          tip="点击上传运动图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.yundongtupian" label="运动图片" prop="yundongtupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yundongtupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiluriqi" label="记录日期" prop="jiluriqi">
              <el-input v-model="ruleForm.jiluriqi" 
                placeholder="记录日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="运动内容" prop="yundongneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yundongneirong" label="运动内容" prop="yundongneirong">
                    <span v-html="ruleForm.yundongneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.baogaoneirong" label="报告内容" prop="baogaoneirong">
                    <span v-html="ruleForm.baogaoneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='baogaomingcheng'){
            this.ruleForm.baogaomingcheng = obj[o];
	    this.ro.baogaomingcheng = true;
            continue;
          }
          if(o=='yundongdidian'){
	...
	this.ruleForm.yundongneirong = this.ruleForm.yundongneirong.replace(reg,'../../../ssm278i6/upload');
	this.ruleForm.baogaoneirong = this.ruleForm.baogaoneirong.replace(reg,'../../../ssm278i6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yundongbaogaojilu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yundongbaogaojiluCrossAddOrUpdateFlag = false;
						 this.parent.search();
