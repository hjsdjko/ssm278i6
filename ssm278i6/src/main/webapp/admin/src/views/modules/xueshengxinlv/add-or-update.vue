<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="我的心率" prop="wodexinlv">
          <el-input v-model="ruleForm.wodexinlv" 
              placeholder="我的心率" clearable  :readonly="ro.wodexinlv"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="我的心率" prop="wodexinlv">
              <el-input v-model="ruleForm.wodexinlv" 
                placeholder="我的心率" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xueshengxinlv/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xueshengxinlvCrossAddOrUpdateFlag = false;
						 this.parent.search();
