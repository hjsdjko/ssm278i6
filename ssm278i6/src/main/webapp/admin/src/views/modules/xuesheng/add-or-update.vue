<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教师姓名" prop="jiaoshixingming">
          <el-select :disabled="ro.jiaoshixingming" v-model="ruleForm.jiaoshixingming" placeholder="请选择教师姓名">
            <el-option
                v-for="(item,index) in jiaoshixingmingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.jiaoshixingmingOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
